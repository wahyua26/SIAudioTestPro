          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <div class="card">
              ...
              <form class="form-card" action="/jabatan" method="post">
                  @csrf
                  <div class="form-group col flex-column d-flex"> <label class="form-control-label px-3">Nama Posisi Pegawai<span class="text-danger"> *</span></label> <input type="text" id="jabatan" name="jabatan" placeholder=""> </div>
                  <div class="form-group col flex-column d-flex"> <label class="form-control-label px-3">Divisi<span class="text-danger"> *</span></label> <input type="text" id="divisi" name="divisi" placeholder="" > </div>
