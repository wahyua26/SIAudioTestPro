      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <div class="small-box text-white">
            <div class="inner">
              <h3>{{ $audiometri }}</h3>
              <p>{{ GoogleTranslate::trans('Hasil Audiometri', app()->getLocale()) }}</p>
            </div>
            <div class="icon">
              <i class="nav-icon fas fa-file-medical"></i>
            </div>
            <a href="/audiometri-pegawai/{{ auth()->user()->id }}" class="small-box-footer text-white">{{ GoogleTranslate::trans('More Info', app()->getLocale()) }} <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col"></div>
      </div>
